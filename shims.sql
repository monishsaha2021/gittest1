...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2021 at 05:38 PM
...
CREATE TABLE `permissions` (
  ...
  `perm_icon` text DEFAULT NULL,
  `perm_link` text DEFAULT NULL,
  `perm_sort` int(10) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `permissions` (`perm_id`, `perm_name`, `perm_icon`, `perm_link`, `perm_sort`) VALUES
(1, 'Configaration', NULL, NULL, 1),
(2, 'Human Resource', NULL, NULL, 2),
(3, 'OPD', NULL, NULL, 3);
...
CREATE TABLE `permission_components` (
  `perm_comp_id` int(10) NOT NULL,
  `perm_sub_id` int(10) DEFAULT NULL,
  `perm_comp_name` varchar(100) DEFAULT NULL,
  `perm_comp_view` enum('0','1') DEFAULT '1',
  `perm_comp_add` enum('0','1') DEFAULT '1',
  `perm_comp_edit` enum('0','1') DEFAULT '1',
  `perm_comp_delete` enum('0','1') DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `permission_submodules`
--

CREATE TABLE `permission_submodules` (
  `perm_sub_id` int(10) NOT NULL,
  `perm_id` int(10) DEFAULT NULL,
  `perm_sub_name` varchar(100) DEFAULT '',
  `perm_sub_icon` text DEFAULT NULL,
  `perm_sub_link` text DEFAULT NULL,
  `perm_sub_sort` int(10) DEFAULT NULL,
  `parent` int(10) DEFAULT 0,
  `show_in_menu` enum('0','1') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `permission_submodules`
--

INSERT INTO `permission_submodules` (`perm_sub_id`, `perm_id`, `perm_sub_name`, `perm_sub_icon`, `perm_sub_link`, `perm_sub_sort`, `parent`, `show_in_menu`) VALUES
(1, 1, 'settings', NULL, NULL, 1, 0, '0'),
(2, 1, 'genaral settings', NULL, NULL, 1, 1, '0'),
(3, 1, 'roles permission', NULL, 'users/User_groups', 2, 1, '0'),
(4, 2, 'staff', NULL, 'human_resource/staff', NULL, 0, '0'),
(5, 3, 'OPD Visit', NULL, 'opd/opd_visit', NULL, 0, '0');
...
CREATE TABLE `users` (
  ...
  `forgotten_password_selector` varchar(100) NOT NULL,
...
INSERT INTO `users` (`id`, `oauth_provider`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `forgotten_password_selector`, `remember_code`, `remember_selector`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `date`, `bio`, `user_img`, `verification_code`) VALUES
(1, '', '', 'Salman Iqbal', '$2y$12$R4uUK7gMFTzj0IpVUhHd3Ol50rU/EqXsnv.1c54RCm78.n5a.cCWS', '', 'admin@admin.com', NULL, NULL, NULL, '', NULL, '', 1268889823, '1632122974', 1, 'Salman', 'Iqbal', 'ADMIN', '0323-9047937', '2017-01-26', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'img1.jpg', 0),
...
ALTER TABLE `permission_components`
  ADD PRIMARY KEY (`perm_comp_id`);

--
-- Indexes for table `permission_submodules`
--
ALTER TABLE `permission_submodules`
  ADD PRIMARY KEY (`perm_sub_id`);
...
--
ALTER TABLE `permission_components`
  MODIFY `perm_comp_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `permission_submodules`
--
ALTER TABLE `permission_submodules`
  MODIFY `perm_sub_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
